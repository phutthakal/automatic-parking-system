...
class MainchangeWindow(QMainWindow):
    def __init__(self):
        super(MainchangeWindow, self).__init__()
    ...
    def fetch_data(self):
        ...
        try:
            ...
            print("ข้อมูลที่ดึงมาเก็บไว้ใน data คือข้อมูลเก่า:",data)
    ...
    def change_lot(self):
        ...
        try:
            if wrong_zone=="1":
                ...
                # print("data after fecth:", data_id)
                ...
                try:
                    ...
                    # print(user_id)
                    # print(update_new_lot_id)
                except:
                    self.ui.status_check_label1.setText("อัพเดทฐานข้อมูลไม่สำเร็จ")
                # print("data after update :",user_data)

                #เปลี่ยน lot_id ใหม่ = 0
                print("new id to change :",user_data[6])
                new_lot_id = user_data[6]
                null_lot_id = None
                value4 = (null_lot_id, new_lot_id)
                updatedb4 =('''UPDATE card SET lot_id=%s WHERE card_id=%s ''')
                try:
                ...
                updatedb2 =('''
                           UPDATE lot SET status_id="6" WHERE lot_id=%s ''')
                try:
